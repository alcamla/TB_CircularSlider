...
#define TB_LINE_WIDTH 15                            //The width of the active area (the gradient) and the width of the handle
#define TB_FONTSIZE 65                              //The size of the textfield font
#define TB_FONTSIZE_SMALL 20                              //The size of the textfield font
...
@property (nonatomic, strong) NSMutableAttributedString *unitsAttributedString;
@property (nonatomic, strong) UIFont *buttonFont;

-(id)initWithFrame:(CGRect)frame
      buttonStates:(NSArray *)buttonStates
unitsAttributedString:(NSAttributedString *)unitsAttString
              font:(UIFont*)font;
@end
